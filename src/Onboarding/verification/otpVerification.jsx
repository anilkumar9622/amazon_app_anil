...
export default function OtpVerification() {
  ...
  return (
    ...
    <div style={{ height: "auto", paddingBottom: "15px" }}>
                ...
                <div style={{ display: "flex", height: "auto", width: "370px", margin: 'auto', border: '1px solid lightgray', borderRadius: "4px", marginBottom: "10px" }}>

                    <div style={{ display: "flex", flexDirection: "column", width: "80%", margin: "auto", paddingTop: "25px", paddingBottom: "25px", gap: "15px" }}>


                        <h2 style={{ height: "6px", fontWeight: "500", fontSize: "28px" }}>Verification required</h2>
                        <div style={{ display: "flex", flexWrap: "wrap", width: "100%", heigth: "auto" }}>
                            <p style={{ fontSize: "1em", fontWeight: "500", marginTop: '5px' }}>To continue, complete this verification step. We've sent an OTP to the mobile number +917667868270. Please enter it below to complete verification. </p></div>
                ...
                <Ripples>        <button
                        ...
                        <div style={{  width: "100%", heigth: "auto", alignItems:'center' }}>
                           ...
                           <div> <Collapse style={{ marginLeft: '0px' }}
                                bordered={false}
                                defaultActiveKey={['2']}
                                expandIcon={({ isActive }) => <CaretRightOutlined rotate={isActive ? 90 : 0} />}
                                className="site-collapse-custom-collapse">
                                <Panel style={{ backgroundColor: "white", textDecorationColor: 'blue' }} header="I need more help" key="1" className="site-collapse-custom-panel">
                                    <p >If you've already tried to reset your password, but haven't received an email from Amazon, check your Junk or Spam folder.</p>
                                    <p>If you can't access your email, try resetting that first through your email provider.</p>
                                    <p>If you've recently updated your password, your old password could still be saved in your browser. Try clearing your browser history and re-typing your password.</p>
                                    <p>If that does not work, please try calling us at 180030001593 so that we can help you out.</p>
                                </Panel>

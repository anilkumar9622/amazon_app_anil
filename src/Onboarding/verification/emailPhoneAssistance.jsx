            ...
            <div style={{ height: "auto", paddingBottom: "15px" }}>
                ...
                <div style={{ display: "flex", height: "auto", width: "350px", margin: 'auto', border: '1px solid lightgray', borderRadius: "4px", marginBottom: "10px" }}>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", width: "80%", margin: "auto", paddingTop: "25px", paddingBottom: "25px", gap: "15px" }}>
                        ...
                        <h2 style={{ height: "6px", fontWeight: "500", fontSize: "28px", marginTop:'0px' }}>Password Assistance</h2>
                        <div style={{ display: "flex", flexWrap: "wrap", width: "100%", heigth: "auto" }}>
                            <p style={{ fontSize: "1em", fontWeight: "500", marginTop: '5px' }}>Enter the email address or mobile phone number associated with the Amazon account.</p></div>
                        <div style={{ display: "flex", flexDirection: "column", gap: "5px", marginTop: "-10px" }}>
                            <b style={{ fontSize: "0.9em" }}>Email or mobile phone number</b>
                            <Input
                                type='text'
                                name="emailphone"
                ...
                <div style={{  height: "auto", width: "350px", margin: 'auto', marginBottom: "10px" }}>
                <div style={{fontSize:'16px', fontWeight:'500'}}>
                    Has your email address or mobile phone number changed?
                </div>
                <div><p>If you no longer use the e-mail address associated with your Amazon account, you may contact Customer Service for help restoring access to your account.</p></div>
                </div>
            </div>

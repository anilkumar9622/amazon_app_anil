...
var decoded = jwt_decode(token);
  ...
  return (
    <>
     ...
     <div onClick={showDrawer} style={{ display: 'flex', fontSize: '1.2vw', color: 'white' }}>
                    <a  class="ex1" style={{ color: 'white', display: 'flex', justifyContent: 'space-around', alignItems: 'center', gap:'6px' }} >
                    <MenuOutlined />  All</a>
                </div>
      ...
      <Drawer style={{ padding: '0px' }}
        ...
        <div class='sidemenu' style={{ position: 'relative' }} >
          ...
          <div style={{ display: "flex", flexDirection: "column", lineHeight: '40px', fontSize: '14px', paddingBottom: '5px', color: "black", borderBottom: '#ddd' }}>
            <a id='menu' href='' style={{ display: "flex", padding: '0px 36px ', justifyContent: "space-between" }}>
